...
parser.add_argument('--mag', type=str, help='Stars magnitude column (Default = modelfit_CModel_mag)', default='modelfit_CModel_mag')
parser.add_argument('--cut', type=float, help='Select the value of the magnitude cut ((g-i) > value)')
parser.add_argument('--dustmap', help='Extinction map (Default = sfd)', default='sfd')
